...
Messages.user_cert_missing = "fichier de certificat personnel non " \
    "trouvé"
Config.instname = "Cranfield University"
Config.profilename = "eduroam"
Config.url = "http://www.cranfield.ac.uk/study/it-services/eduroam"
Config.email = "servicedesk@cranfield.ac.uk"
Config.title = "eduroam CAT"
Config.server_match = "ccclearpass-vip.central.cranfield.ac.uk"
...
Config.init_confirmation = "Cet installateur ne fonctionnera " \
    ...
    "{1}."
Config.user_realm = "cranfield.ac.uk"
Config.ssids = ['eduroam', 'Resnet Personal']
Config.del_ssids = []
Config.servers = ['DNS:ccclearpass-vip.central.cranfield.ac.uk']
Config.use_other_tls_id = False
Config.hint_user_input = True
Config.verify_user_realm_input = True
Config.tou = ""
Config.CA = """-----BEGIN CERTIFICATE-----

-----END CERTIFICATE-----
"""

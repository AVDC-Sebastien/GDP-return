    ...
    if marker_ids is not None:
      ...
      for i, marker_id in enumerate(marker_ids):
       ...
       if marker_id == 3:
          ...
          euler_try = r.as_euler('zxy', degrees=True)
          quat = r.as_quat()   
          ...
          roll_x, pitch_y, yaw_z = quat2eulers(transform_rotation_x, 
          ...
          camera_measurement = [[transform_translation_x, transform_translation_y, transform_translation_z, roll_x, pitch_y, yaw_z]]
          euler_try = [euler_try[0], euler_try[1], euler_try[2]]                

          new_row = [ 
                    t1,  # Temps (simulé ici)
                    camera_measurement,
                    euler_try
                    ] # Valeurs (simulées ici) converties en liste
          ...
          # print("roll_z: {}".format(roll_x))
          # print("pitch_y: {}".format(pitch_y))                                 #j'ai changé, finir le changement, c'est le code affiche bizarement
          # print("yaw_x: {}".format(yaw_z))

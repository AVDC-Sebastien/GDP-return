...
chemin_fichier = 'camera_nicoco.csv';
...
colonne_1 = T(:, 1).Variables*0.01 - 3.8; % Première colonne
colonne_6 = -T(:, 6).Variables*0.001 + 0.03 ;% Sixième colonne
colonne_7 = T(:, 7).Variables*0.001 + 0.073;
colonne_8 = T(:, 8).Variables*0.001 - 0.08;
